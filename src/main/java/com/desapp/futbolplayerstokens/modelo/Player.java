...
public class Player {
    ...
    @Builder.Default
    private Integer availableTokens = 100;
    @Builder.Default
    private Integer totalTokens = 100;
    ...
    public void applyPersistenceDefaults() {
        ...
        availableTokens = defaultIfNull(availableTokens, 100);
        totalTokens = defaultIfNull(totalTokens, 100);
